...
public final class TerrainSystem extends RenderableSpacePartitioningGrid{
		...
		public Void call() throws Exception {
			...
			{// Start scope
				...
				for (int cX = gX; cX < gX + chunkSideLength; cX++) {
					...
					entrance = new PortalEntrance(portalModel,exit,tr.mainRenderer.getCamera());
	...
	public TunnelPoint(TDFFile.Tunnel tun, boolean entrance){
	    ...
	    textureToInsert = tr.getResourceManager().getRAWAsTexture(texFile, tr.getGlobalPaletteVL(),null,false, true);}
