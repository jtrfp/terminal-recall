...
@Component
public class KeyboardInputDeviceServiceFactory implements FeatureFactory<ControllerMapper> {
    public class KeyboardInputDeviceService extends AbstractInputDeviceService {
	...
	return new KeyboardInputDeviceService();
    }
