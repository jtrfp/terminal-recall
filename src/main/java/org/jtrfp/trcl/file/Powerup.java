...
public enum Powerup{
	...
	PAC(Weapon.PAC,100,0,0,0,0,false,Integer.MAX_VALUE,new String[]{
	...
	ION(Weapon.ION,100,0,0,0,0,true,Integer.MAX_VALUE,new String[]{
	...
	MAM(Weapon.MAM,40,0,0,0,0,false,Integer.MAX_VALUE,new String[]{
	...
	SAD(Weapon.SAD,20,0,0,0,0,false,Integer.MAX_VALUE,new String[]{
	...
	SWT(Weapon.SWT,20,0,0,0,0,false,Integer.MAX_VALUE,new String[]{
	...
	shieldRestore(null,0,65535,0,0,0,false,Integer.MAX_VALUE,new String[]{
	...
	invisibility(null,0,0,1000*30,0,0,false,Integer.MAX_VALUE,new String[]{
	...
	invincibility(null,0,0,0,1000*30,0,false,Integer.MAX_VALUE,new String[]{
	...
	DAM(Weapon.DAM,1,0,0,0,0,false,1,new String[]{
	...
	Powerup(Weapon weapon, int weaponSupplyDelta, 
		int shieldDelta, 
