...
public enum Weapon {
    ...
    PAC("PAC", "SKL", new BINModelingType("LASER3.BIN"), 4096, //LASER3.BIN
	    ModelingType.MAP_SQUARE_SIZE * 4, 1, 2048, true, false), 
    ION("ION",
	    "DC1", new BINModelingType("LASER4.BIN"), 8192,
	    ModelingType.MAP_SQUARE_SIZE * 4, 2, 2048, false, false), 
    RTL(
    ...
    blueLaser(null, null, new BINModelingType("LASER9.BIN"), 4096,
	    ModelingType.MAP_SQUARE_SIZE * 5, -1, 2048, false, false), 
    bullet(
    ...
    purpleBall(
	    null, null, new BillboardModelingType(new String[] { "PBALL1.RAW",
		    ...
		    320000)), 6554, ModelingType.MAP_SQUARE_SIZE * 3, -1, 2048,
	    false, false), 
    blueFireBall(null, null, new BillboardModelingType(
	    ...
	    ModelingType.MAP_SQUARE_SIZE * 3, -1, 2048, false, false), 
    goldBall(
	    null, null, new BINModelingType("FIREBALL.BIN"), 8000,
	    ModelingType.MAP_SQUARE_SIZE * 10, -1, 2048, false, false), 
    atomWeapon(
    ...
    purpleRing(
	    ...
	    8192, ModelingType.MAP_SQUARE_SIZE * 4, -1, 2048, false, false), 
    bossW6(
