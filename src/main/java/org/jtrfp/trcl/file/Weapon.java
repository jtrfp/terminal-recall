...
public enum Weapon{
	...
	ION("ION","DC1",new BillboardModelingType(new String[]{"PULSE0.RAW","PULSE1.RAW","PULSE2.RAW"},70,new Dimension(320000,320000)),8192,ModelingType.MAP_SQUARE_SIZE*6,2,2048,false,false),
	...
	blueFireBall(null,null,new BillboardModelingType(new String[]{"BFIRJ0.RAW","BFIRJ2.RAW"},100,new Dimension(320000,320000)),6554,ModelingType.MAP_SQUARE_SIZE*6,-1,2048,false,false),
