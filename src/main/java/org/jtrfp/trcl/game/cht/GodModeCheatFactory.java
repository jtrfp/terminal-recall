...
@Component
public class GodModeCheatFactory extends AbstractCheatFactory {
    private static final String CHEAT_NAME = "Invincibility (Toggle)";

    protected GodModeCheatFactory() {
	super(CHEAT_NAME);
    }

    @Override
    public Class<GodModeCheat> getFeatureClass() {
	...
	protected void invokeCheat() {
	    ...
	    //Toggle
	    db.setEnable(!db.isEnabled());
	    //Inform
	    disp.submitMomentaryUpfrontMessage("Invincibility "+(db.isEnabled()?"Off":"On"));
	}//end invokeCheat()
