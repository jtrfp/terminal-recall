...
const int OBJECT_TEXTURE_SIDE_LEN   =512;
const int OBJECT_TEXTURE_BOTTOM     =OBJECT_TEXTURE_SIDE_LEN-1;
const int TEXELS_PER_OBJECT         =4;
const int OBJECTS_PER_ROW           =OBJECT_TEXTURE_SIDE_LEN/TEXELS_PER_OBJECT;
